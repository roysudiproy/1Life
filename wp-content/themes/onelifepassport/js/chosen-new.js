...
sel_val=jQuery.makeArray( jQuery(this).val() );
sel_val_id=(sel_val[sel_val.length-1]);

if (typeof sel_val_id === "undefined") {
...
if(sel_val_id!=""){
	...
	jQuery.ajax({
		type:"get",
		url:""+site_url+"/?add-to-cart="+sel_val_id+"",
		data:sel_val,			
	
	}).done(function(){			
		jQuery("#jq_update_cart").prop('disabled', false).trigger("click");
...
jQuery( document.body ).trigger( '#jq_update_cart' ).ajaxStop(function(){
    window.location.href = permalink;
});
});
